...
export default function VideosPage() {
  ...
  const filteredVideos = videos.filter((video) => {
    const videoTitle = Array.isArray(video.title)
      ? video.title[0]
      : video.title;
        ...
        {!loading && (
          <div className="mb-4 flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              {searchTerm
                ? `${sortedVideos.length} results for "${searchTerm}"`
                ...
                >
                      ...
                      <Link href={`/creator/${video.creatorId || "unknown"}`}>
                        <Avatar className="h-8 w-8 border">
                          <AvatarImage
                            ...
                            alt={
                              Array.isArray(video.creatorName)
                                ? video.creatorName[0]
                  ...
                  <CardFooter className="flex items-center justify-end border-t p-2">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="mr-auto h-8 px-2 text-xs text-primary"
                      asChild
                    >
